...
public:
  ...
  qint32 eqsltimer() const;
  qint32 harmonicsdepth() const;
  qint32 nsingdecatt() const;
  qint32 ntopfreq65() const;
  qint32 nbacktocq() const;
  qint32 nretransmitmsg() const;
  qint32 nhalttxsamemsgrprt() const;
  qint32 nhalttxsamemsg73() const;
  bool fmaskact() const;
  bool backtocq() const;
  bool retransmitmsg() const;
  bool halttxsamemsgrprt() const;
  bool halttxsamemsg73() const;
