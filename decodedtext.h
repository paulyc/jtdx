// This source code file was last time modified by Arvo ES1JA on August 17th, 2017
...
1619 -29  2.5  702 # CQ ZS6BK KG43         *   real _string
"
...
private:
    ...
    QRegularExpression _gridRe = QRegularExpression("^[A-Ra-r]{2,2}[0-9]{2,2}");
...
//    QRegularExpression _callRe = QRegularExpression("([BFGIKMNRTW]|[A-Z0-9]{2})[0-9][A-Z0-9]{0,3}[A-Z]");
    QRegularExpression _callRe = QRegularExpression("[2-9]{0,1}[A-Z]{1,2}[0-9]{1,4}[A-Z]{1,6}");
};
