// This source code file was last time modified by Vytas LY3BG on June 15th, 2017
    ...
    if (inputFile.open(QIODevice::ReadOnly))
    {
        ...
        while ( !in.atEnd() )
        {
            ...
            if (q.call != "") {
                ...
                if (country.length() > 0) { //  country was found
...
void ADIF::add(const QString call, const QString band, const QString mode, const QString date, const QString gridsquare)
{
    QSO q;
    q.call = call;
    q.band = band;
