// This source code file was last time modified by Igor UA3DJY on April 17th, 2017
    ...
    case Active:
      {
        ...
        unsigned const i0 = m_tuning ? 9999 * m_nsps : (m_symbolsLength - 0.034) * 4.0 * m_nsps;
...
//                            << toneFrequency0 << m_nsps;
          ...
          if (m_phi > m_twoPi) m_phi -= m_twoPi;
//ramp for first tone
          if(m_ic==1) m_amp = m_amp * 0.008144735;
          if(m_ic > 1 and  m_ic < 192) m_amp = m_amp / 0.975;
//ramp for last tone
