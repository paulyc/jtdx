! This source code file was last time modified by Igor UA3DJY on July 8th, 2017
...
module jt9s_decode
  ...
  abstract interface
     subroutine jt9s_decode_callback (this, utc, sync, snr, dt, freq, drift, decoded, servis9)
       import jt9s_decoder
       implicit none
...
!npts8 = 74736
    ...
    character msg*22,servis9*1,mycall*6,hiscall*6,hisgrid*4,chint*1,hiscallrxf*6
